...
def showhelp():
    usage()
    print('Main options:')
    print('  -c, --compat           Test the specified --threat or --url')
    print('                         for compatibility')
    print('  -d, --debug            Turn on debug options likely only useful')
    print('                         to the author of this script')
    print('  -h, --help')
    print('  -l, --list             List all available threat modules')
    print('  -r, --run              Run the specified --threat or --url')
    print('  -s, --sleep            Sleep time in seconds between steps of the')
    print('                         specified --threat or --url')
